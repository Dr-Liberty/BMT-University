    ...
    <section className="py-16 px-4 sm:px-6" data-testid="section-featured-courses">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            <h2 className="font-heading font-bold text-3xl text-white mb-2">{t('courses.featured')}</h2>
            <p className="text-muted-foreground">{t('courses.featuredSubtitle')}</p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="font-heading font-semibold text-xl text-white mb-2">{t('common.error')}</h3>
            <p className="text-muted-foreground mb-6">{t('common.tryAgain')}</p>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="font-heading font-semibold text-xl text-white mb-2">{t('courses.noCoursesFound')}</h3>
